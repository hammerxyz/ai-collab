...
- test_type: {unit | integration | adversarial | regression | blackbox | whitebox}
...
- {ISO8601} | TEST | Submitted test report
...
- [ ] verdict 明确为 PASS / CONDITIONAL / FAIL 之一
- [ ] 测试范围独立于 IMPL 的 Implementation Hints
